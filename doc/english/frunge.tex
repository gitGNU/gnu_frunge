 \documentclass[
   titlepage=no,
   bibliography=totoc,
   ]{scrartcl} %cuſtom titlepage: ſtill to come
...
%% font settings
 \setmainfont{Linux Libertine O} %In case of a compilation error: You have to install the .otf versions of the “Linux Libertine” font family, not just the versions in the inferior .ttf format!
...
%% text commands
 \newcommand{\andnewline}{% a quick and dirty hack to typeset the authors in a 2×2 matrix
 \end{tabular}\\%
 \begin{tabular}[t]{c}}

 \newcommand*\team{Dennis Heidſiek\and Chriſtian Kluge\andnewline Martin Roppelt\and Arno Trautmann}
 ...
 \thispagestyle{empty}
 \begin{abstract}
\large Copyright 2009, 2010 Dennis Heidſiek
(\href{mailto:heidsiekb@aol.com}{heidsiekb@aol.com}), Chriſtian Kluge\break
(\href{mailto:ckfrakturfreak@web.de}{ckfrakturfreak@web.de}), Martin
Roppelt (\href{mailto:m.p.roppelt@web.de}{m.p.roppelt@web.de}) and Arno\break
...
\addsec{Blacken converter}
This is a Java baſed program to convert text in antiqua to blackletter,
reſpecting the language ſpecific rules, and vice verſa. It’s ſtill in a
very early phaſe of development and rests upon Liangs’ widly uſed hyphenation
algorithm introduced in \cite{liang}.
