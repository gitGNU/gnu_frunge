...
\newcommand\frungepangramm{\IfFileExists{frunge-pangramm.txt}{\input{frunge-pangramm.txt}}{Test}}
...
\addpart{\texorpdfstring{\XeTeX-Usage}{XeTeX-Usage}}
...
\addpart{Testing of Fonts}
You can teſt the Frunge fonts in this document with the command \verb|\frungepangramm| wich will type the following text:
\begin{quote}
\frungepangramm
\end{quote}
This (non-ſenſical) text has all important glyphs to ſhow how a blackletter font would look like. The text is ſaved in the file \verb|frunge-pangramm.txt| and might change from time to time—if we have better ideas for it \winkey
