...
public class Converters {
	...
	protected final static List<String> LANGUAGES = Arrays.asList("de", "en", "la");
	...
	/**
	 * @param in a language code from the <a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes">List of ISO_639-1 codes</a>
