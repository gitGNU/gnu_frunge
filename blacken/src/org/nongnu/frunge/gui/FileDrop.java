...
public class FileDrop {
	...
	public FileDrop(final java.awt.Component c, final Listener listener) {
		this(null, // Logging stream
				...
				javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2,
						FileDrop.defaultBorderColor), // Drag border
				true, // Recursive
				listener);
	} // end constructor
	 ...
	 * its children components will also listen for drops, though only the parent
	 * will change borders.
	 * 
	 * @param c
	 *          Component on which files will be dropped.
	...
	public FileDrop(final java.io.PrintStream out, final java.awt.Component c,
		...
		this(out, // Logging stream
				c, // Drop target
				javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2,
						FileDrop.defaultBorderColor), false, // Recursive
				listener);
	} // end constructor
	...
	public FileDrop(final java.io.PrintStream out, final java.awt.Component c,
		...
		if (FileDrop.supportsDnD()) { // Make a drop listener
			this.dropListener = new java.awt.dnd.DropTargetListener() {
	...
	private static boolean supportsDnD() { // Static Boolean
		if (FileDrop.supportsDnD == null) {
			...
			FileDrop.supportsDnD = new Boolean(support);
		} // end if: first time through
		return FileDrop.supportsDnD.booleanValue();
	} // end supportsDnD
		...
		try {
			...
			while ((line = bReader.readLine()) != null) {
				try {
					...
					if (FileDrop.ZERO_CHAR_STRING.equals(line)) {
						continue;
					}
	...
	public static boolean remove(java.io.PrintStream out, java.awt.Component c,
																boolean recursive) { // Make sure we support
		// dnd.
		if (FileDrop.supportsDnD()) {
			...
			if (recursive && (c instanceof java.awt.Container)) {
				...
				for (Component comp : comps) {
					FileDrop.remove(out, comp, recursive);
				}
				return true;
			} // end if: recursive
			else {
	...
	public static class TransferableObject implements
		...
		public final static java.awt.datatransfer.DataFlavor DATA_FLAVOR = new java.awt.datatransfer.DataFlavor(
				FileDrop.TransferableObject.class, TransferableObject.MIME_TYPE);
		...
		public TransferableObject(Object data) {
			this.data = data;
			this.customFlavor = new java.awt.datatransfer.DataFlavor(data.getClass(),
		...
		public java.awt.datatransfer.DataFlavor[] getTransferDataFlavors() {
			if (this.customFlavor != null) {
				return new java.awt.datatransfer.DataFlavor[] { this.customFlavor,
						TransferableObject.DATA_FLAVOR,
		...
		public Object getTransferData(java.awt.datatransfer.DataFlavor flavor)
				...
				java.io.IOException {
			// Native object
			if (flavor.equals(TransferableObject.DATA_FLAVOR)) {
